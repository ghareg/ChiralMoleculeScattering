	...
	for (int ind1 = 0; ind1 < (re - rs); ++ind1) {
		...
		for (int nc = 0; nc <= nmax; ++nc) {
			for (int mc = -mmax; mc <= mmax; ++mc) {
				...
				I10t = mult * I10(nc, -mc, -pm.kSinth);
				I12t = mult * I12(nc, -mc, -pm.kSinth);
				I21t = mult * I21(nc, -mc, -pm.kSinth);
				I31t = mult * I31(nc, -mc, -pm.kSinth);
				I23t = mult * I23(nc, -mc, -pm.kSinth);
				I33t = mult * I33(nc, -mc, -pm.kSinth);
				I42t = mult * I42(nc, -mc, -pm.kSinth);
				I52t = mult * I52(nc, -mc, -pm.kSinth);
				I2m1t = mult * I2m1(nc, -mc, -pm.kSinth, I30i, I31i);
				I3m1t = mult * I3m1(nc, -mc, -pm.kSinth, I30i, I31i);
				I40t = mult * I40(nc, -mc, -pm.kSinth, I30i, I31i);
				I50t = mult * I50(nc, -mc, -pm.kSinth, I30i, I31i);
				I60t = mult * I60(nc, -mc, -pm.kSinth, I30i, I31i);
				I62t = mult * I62(nc, -mc, -pm.kSinth);
				I70t = mult * I70(nc, -mc, -pm.kSinth, I30i, I31i);
				I72t = mult * I72(nc, -mc, -pm.kSinth);
				I451t = mult * I451(nc, -mc, -pm.kSinth);
				I91t = mult * I91(nc, -mc, -pm.kSinth, I30i, I31i);
				I101t = mult * I101(nc, -mc, -pm.kSinth, I30i, I31i);	
